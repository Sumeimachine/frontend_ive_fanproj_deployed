...
- Reset password page is available at `/reset-password?token=...` or `/auth/reset-password?token=...` and posts to `/Auth/reset-password`.
- Verify tab in login page now uses `/Auth/resend-verification` with email.
